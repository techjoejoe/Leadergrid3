  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'glow-gold': {
            '0%, 100%': { boxShadow: '0 0 20px 5px rgba(252, 211, 77, 0.4)' },
            '50%': { boxShadow: '0 0 30px 10px rgba(252, 211, 77, 0.7)' },
        },
        'glow-silver': {
            '0%, 100%': { boxShadow: '0 0 20px 5px rgba(203, 213, 225, 0.4)' },
            '50%': { boxShadow: '0 0 30px 10px rgba(203, 213, 225, 0.7)' },
        },
        'glow-bronze': {
